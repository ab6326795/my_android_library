...
public class PullToLoadListView extends ListView implements OnScrollListener {  
    ...
    public void onScroll(AbsListView view, int firstVisiableItem, int visibleItemCount,  int totalItemCount) {  
        isShowLastItem=(visibleItemCount==totalItemCount);
    }  
    ...
    public boolean onTouchEvent(MotionEvent event) {  
        ...
        case MotionEvent.ACTION_MOVE:  
            ...
            if (state != REFRESHING && isRecored) {  
                ...
                if (state == RELEASE_To_REFRESH) {  
                    ...
                    if ((startY-tempY < headContentHeight+20)  
                            && (startY-tempY) > 0) {  
                ...
                // 还没有到达显示松开刷新的时候,DONE或者是PULL_To_REFRESH状态   
                    ...
                    if (startY-tempY >= headContentHeight+20 && currentScrollState == SCROLL_STATE_TOUCH_SCROLL) {  
     ...
     /*           
                ...
                if (state == PULL_To_REFRESH) { 
                	int topPadding = (int)((-1 * headContentHeight + (startY-tempY)));
                ...
                if (state == RELEASE_To_REFRESH) {  
                	int topPadding = (int)((startY-tempY - headContentHeight));
                	headView.setPadding(headView.getPaddingLeft(), topPadding, headView.getPaddingRight(), headView.getPaddingBottom());    
                    headView.invalidate();  
    ...
    private void changeHeaderViewByState() {  
        ...
        case RELEASE_To_REFRESH:  
            ...
            if(!TextUtils.isEmpty(lastUpdatedTextView.getText()))
