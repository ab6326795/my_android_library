...
package com.pwdgame.imagecache;
...
import com.pwdgame.tasks.AsyncMockTask;
import com.pwdgame.widget.TextRoundDrawable;
...
public abstract class ImageLoader {
    ...
    protected ImageLoader(Context context,int mImageSize) {
    	mContext=context;
     ...
     * @param round
     */
    public void setImageRound(boolean round){
    	mRoundBitmap=round;
    }
     ...
     */
    private class BitmapWorkerTask extends AsyncMockTask<Object, Void, Bitmap> {
        private Object data;
        ...
        protected Bitmap doInBackground(Object ... params) {
            ...
            if (bitmap != null && mImageCache != null) {
            	//进行图片圆角处理
            	if(mRoundBitmap){
            	   roundBitmap=new TextRoundDrawable(mContext, bitmap,getImageSize()).getTextBitmap();
                ...
                mImageCache.addBitmapToCache(dataString, roundBitmap);
            }
