...
import com.pwdgame.util.VersionUtils;
...
public class ImageCache {
     ...
     */
    public ImageCache(float memCacheSizePercent) {
...
/*            *//**
    ...
    public void remove(String key){
    	if(mMemoryCache!=null){
    		Bitmap tmp=mMemoryCache.get(key);
    ...
    public void clearAll() throws Exception{
    	if(mMemoryCache!=null){    		
    		if (mMemoryCache.size() > 0) {
        		...
        		for(Entry<String, Bitmap> temp:map.entrySet()){
        			Bitmap bitmap=temp.getValue();
    ...
    public static int calculateMemCacheSize(float percent) {
        ...
        int cacheMemory=Math.round(percent * Runtime.getRuntime().freeMemory() / 1024);
        if(BuildConfig.DEBUG){
        	Log.e(TAG,  Runtime.getRuntime().freeMemory() / 1024+", LruCache:"+cacheMemory);
        }
        return cacheMemory;
    }
