...
public class SlideBar extends View {
	...
	public void setListText(String[] b){
		this.b=b;		
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < b.length; i++) {
			//ff2182bf   154,154,154
			paint.setColor(Color.rgb(43,145,207));
			// paint.setColor(Color.WHITE);
			paint.setTypeface(Typeface.DEFAULT_BOLD);
			paint.setAntiAlias(true);
			paint.setTextSize(Utility.dipToPx(getContext(), 12));
			// 选中的状态
			if (i == choose) {
				paint.setColor(Color.parseColor("#ff01c676"));
