 ...
 *
 */
public class XYGridDivideView  extends ViewGroup {
	...
	public XYGridDivideView (Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		if (attrs != null) {
			TypedArray a = getContext().obtainStyledAttributes(attrs,
					R.styleable.XYGridDivideLayout);
			colums = a.getInteger(R.styleable.XYGridDivideLayout_numColumns, 2);
			margin = (int) a.getInteger(R.styleable.XYGridDivideLayout_itemMargin, 2);
		}
	}

	public XYGridDivideView (Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public XYGridDivideView (Context context) {
		this(context, null);
	}
